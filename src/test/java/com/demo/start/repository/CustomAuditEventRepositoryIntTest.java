package com.demo.start.repository;

import com.demo.start.StartApp;
import com.demo.start.config.Constants;
import com.demo.start.config.audit.AuditEventConverter;
import com.demo.start.domain.PersistentAuditEvent;
...
import static com.demo.start.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
